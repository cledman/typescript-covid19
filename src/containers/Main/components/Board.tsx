    ...
    function Board({data} : { data: Data}){
        ...
        return (
            ...
            <Grid container spacing={5}>
                ...
                <Grid item xs={12} md={3} >
                    <Card value={getValue(todayDeaths ? todayDeaths:0)} label="Total de Óbitos hoje" color="#f7bb29" />               
                </Grid>                
                <Grid item xs={12} md={3} >
                    <Card value={getValue(todayCases ? todayCases:0)} label="Total de Casos hoje" color="#000" />               
                </Grid>                    
                <Grid item xs={12} md={3} >
